...
for metvar in metvars:
    ...
    if metvar == 'Z500Anom':
        ...
        folderpath = f'I:\\Emma\\FIROWatersheds\\Data\\DailyMERRA2\\Z300'
    ...
    merravar = {'Z500':'H','SLP':'SLP','850T':'T','Z850':'H','Z300':'H'}
    ...
    for n in np.arange(eventstart,eventstart+eventlength,1):
        ...
        colorm = map.pcolor(xi,yi,arr,shading='auto',cmap='jet',zorder=1)
        ...
        contour_w = 0.7
        #create contour map
        contourm = map.contour(xi,yi,arr,colors=contour_c,linewidths=contour_w,zorder=2)
