...
fig.suptitle('Precipitation and IVT Vector Composites',fontsize=13,fontweight="bold",y=0.9875)
...
os.chdir(save_dir)
plt.savefig('GRIMET_precipitiation_IVT_SOM_composite.png',dpi=300)
plt.show()