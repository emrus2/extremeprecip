...
os.chdir(save_dir)
if IVT == True:
    plt.savefig('GRIMET_PrecipitiationMonthlyProportion_IVT_SOM_composite.png',dpi=300)
else:
    plt.savefig('GRIMET_PrecipitiationMonthlyProportion_SOM_composite.png',dpi=300)
plt.show()