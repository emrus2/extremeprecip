...
if numpatterns == 12:
    ...
    os.chdir(save_dir)
    if IVT == True:
        plt.savefig(f'GRIMET_PrecipitiationMonthlyProportion_IVT_SOM_composite_{clusters}d_lettered.png',dpi=300)
    else:
        plt.savefig(f'GRIMET_PrecipitiationMonthlyProportion_SOM_composite_{clusters}d_lettered.png',dpi=300)
    plt.show()