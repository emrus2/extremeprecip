...
#%% REDUCE NODE PATTERN
nodepat = patterns[node,:] # see if this is correct
...
cbar_y, cbar_len, cbar_wid = (0.99,0.07,0.01)
cbar_x = {0:0.918,1:0.84,2:0.76}
...
os.chdir(save_dir)
plt.savefig(f'{numpatterns}node_{node}Node_composites_test.png',dpi=300)
plt.show()
