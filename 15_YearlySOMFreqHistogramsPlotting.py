...
numpatterns = 9
percentile = 90
data = np.load(f'I:\\Emma\\FIROWatersheds\\Data\\{percentile}Percentile_{numpatterns}NodeAssignYearlyHistogram.npy')
#data[data == 0] = 'nan'

totaldays = np.load(f'I:\\Emma\\FIROWatersheds\\Data\\{percentile}Percentile_{numpatterns}NodeAssignTotalYearly.npy')
...
ax.set_xticks(x, months,rotation=60,fontsize=7.5)
...
os.chdir(save_dir)
plt.savefig(f'{percentile}_{numpatterns}_NodeFreqYearlyNum.png',dpi=300,bbox_inches='tight',pad_inches=0.08)
plt.show()