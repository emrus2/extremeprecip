...
numpatterns = 12
clusters = 3
soms = scipy.io.loadmat(os.path.join(folder,f'SOMs\\SomOutput\\IVT_90_{numpatterns}sompatterns_{clusters}d.mat')) 
...
# extremedays_assign = np.load(os.path.join(folder,f'90Percentile_ExtremeDays_{clusters}d_{numpatterns}NodeAssign.npy'),allow_pickle=True)
...
#%% SAVE FILES
np.save(os.path.join(folder,f'ARFrequencies_{numpatterns}node_{clusters}d.npy'),soms_arfreq)
