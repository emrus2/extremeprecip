...
# for node in range(1,2):
    ...
    highlims = {'Z500':5700,'SLP':1034,'IVT':825,'300W':75,'850T':293, \
    ...
    for i in ivals:
        ...
        # add subplot
            ...
            #add yuba shape
            plt.scatter(-120.9,39.5,color='w',marker='*',linewidths=0.5,zorder=6, s=100, edgecolor='0.2')
            place += 1
    ...
    os.chdir(save_dir)
    plt.savefig(f'{numpatterns}node_{node}Node_{clusters}d_composites_testingnew.png',dpi=300)
    plt.show()
