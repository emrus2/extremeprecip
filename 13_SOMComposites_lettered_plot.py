...
metvars = ['300W','Z500Anom','SLP','850TAnom']
metvars = ['850TAnom']
#metvar = '300W'
...
#%% INCLUDE CALCULATION OF IVT VECTORS
 ...
 #   elif percentile == 90:
    ...
    plottitle = {'300W':'a','Z500Anom':'b','SLP':'c','850TAnom':'d'}
    ...
    fig.suptitle(f'{plottitle[metvar]})',fontsize=11,fontweight="bold",y=0.997,x=0.06)
    ...
    fig.subplots_adjust(left=0.045,right=0.895,bottom=0.026, top=0.97,hspace=0.05, wspace=0.05) #bottom colorbar
    ...
    os.chdir(save_dir)
    plt.savefig(f'{metvar}_{percentile}_{numpatterns}_SOM_composite_lettered.png',dpi=300)
    plt.show()