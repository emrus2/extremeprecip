...
ax.set_xticks(x, labels=ticklabels,rotation=85,fontsize=7.5)
...
os.chdir(save_dir)
plt.savefig(f'{percentile}_{numpatterns}_NodeFreqYearlyNum_wateryear_{clusters}d_poster.png',dpi=300,bbox_inches='tight',pad_inches=0.08)
plt.show()