...
for i, arr in enumerate(patterns):
    ...
    for j in range(len(merrareduced)):
        ...
        ax = fig.add_subplot(3,9,plotloc)
        if i == 0:
            ax.set_ylabel(f'Day {place-3}',fontsize=8.5,fontweight="bold",labelpad=0.3)
...
fig.subplots_adjust(left=0.01,right=0.945,bottom=0.026, top=0.985,hspace=0.05, wspace=0.05) #bottom colorbar
